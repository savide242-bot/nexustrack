import { BarChart3, Megaphone, ShoppingCart, Users, Settings, Plug, Bell, LogOut, Zap, FileText, Radar, Target } from "lucide-react";
...
const navItems = [
  ...
  { title: "Controlar Anúncios", icon: Target, href: "/ads" },
